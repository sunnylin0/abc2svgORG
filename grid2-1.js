...
p_v.clef.invis=true;p_v.clef.clef_none=1
p_v.key.k_sf=0
...
break}}}}},set_w:function(of,s){of(s)
if(!s.p_v||!s.p_v.grid2||!s.a_gch||((!s.prev||s.prev.invis)&&(!s.next||s.next.invis)))
return
var i,gch
for(i=0;i<s.a_gch.length;i++){gch=s.a_gch[i]
if(gch.type=='g'){if(s.wl<-gch.x)
s.wl=-gch.x
