...
function new_clef(clef_def) {
  ...
  if (clef_def[i + 1] != '8' && clef_def[i + 1] != '1') return s;
  switch (
    clef_def[i] // octave
  ) {
    case '^':
...
function nt_trans(nt, a) {
  ...
  b40 = abc2svg.pab40(nt.pit, a) + curvoice.tr_sco; // base-40 transposition
